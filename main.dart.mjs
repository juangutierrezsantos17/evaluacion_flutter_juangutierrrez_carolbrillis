...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1263: x0 => x0.length,
      _1343: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
      _1344: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
      _1360: (x0,x1) => x0.getItem(x1),
      _1361: (x0,x1) => x0.removeItem(x1),
      ...
      _1400: Object.is,
      _1401: o => o instanceof Array,
      _1406: a => a.pop(),
      _1407: (a, i) => a.splice(i, 1),
      _1408: (a, s) => a.join(s),
      _1409: (a, s, e) => a.slice(s, e),
      _1411: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1412: a => a.length,
      _1414: (a, i) => a[i],
      _1415: (a, i, v) => a[i] = v,
      _1417: o => {
      ...
      _1418: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1420: o => o instanceof Uint8Array,
      _1421: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1422: o => o instanceof Int8Array,
      _1423: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1424: o => o instanceof Uint8ClampedArray,
      _1425: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1426: o => o instanceof Uint16Array,
      _1427: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1428: o => o instanceof Int16Array,
      _1429: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1430: o => o instanceof Uint32Array,
      _1431: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1432: o => o instanceof Int32Array,
      _1433: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1435: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1436: o => o instanceof Float32Array,
      _1437: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1438: o => o instanceof Float64Array,
      _1439: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1440: (t, s) => t.set(s),
      _1442: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1444: o => o.buffer,
      _1445: o => o.byteOffset,
      _1446: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1447: (b, o) => new DataView(b, o),
      _1448: (b, o, l) => new DataView(b, o, l),
      _1449: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1450: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1451: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1452: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1453: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1454: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1455: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1456: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1457: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1458: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1459: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1460: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1463: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1464: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1465: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1466: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1467: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1468: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1481: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1482: (handle) => clearTimeout(handle),
      _1483: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1484: (handle) => clearInterval(handle),
      _1485: (c) =>
      ...
      _1522: o => [o],
      _1523: (o0, o1) => [o0, o1],
      _1524: (o0, o1, o2) => [o0, o1, o2],
      _1525: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1539: x0 => x0.index,
      _1541: x0 => x0.flags,
      _1542: x0 => x0.multiline,
      _1543: x0 => x0.ignoreCase,
      _1544: x0 => x0.unicode,
      _1545: x0 => x0.dotAll,
      _1546: (x0,x1) => { x0.lastIndex = x1 },
      _1547: (o, p) => p in o,
      _1548: (o, p) => o[p],
      ...
      _1565: (x0,x1) => new WebSocket(x0,x1),
      _1566: (x0,x1) => x0.send(x1),
      _1567: (x0,x1,x2) => x0.close(x1,x2),
      _1568: (x0,x1) => x0.close(x1),
      _1569: x0 => x0.close(),
      ...
      _3485: () => globalThis.window,
      _3528: x0 => x0.location,
      _3547: x0 => x0.navigator,
      _3811: x0 => x0.localStorage,
      _3819: x0 => x0.href,
      _3936: x0 => x0.userAgent,
      _3987: x0 => x0.data,
      _4034: (x0,x1) => { x0.onmessage = x1 },
      _4141: x0 => x0.length,
      _4358: x0 => x0.readyState,
      _4371: (x0,x1) => { x0.binaryType = x1 },
      _4374: x0 => x0.code,
      _4375: x0 => x0.reason,
      _6083: x0 => x0.signal,
      _7919: x0 => x0.value,
